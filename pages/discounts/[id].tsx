...
const Discounts: NextPage = () => {
    ...
    const { data: discountById, isLoading: isDiscountByIdLoading, refetch: refetchDiscountById } = api.useGetDiscountByIdQuery({discountId: discount_id_parse, page: currentPage});


    console.log(discountById)

    const [openModal, setOpenModal] = useState(false);
    const MainLoader = isDiscountByIdLoading ;
        ...
        <>
            ...
            <CustomPaginationWrapper>
                <ReactPaginate
                    ...
                    pageCount={discountById.links.length - 2} // add page count and remove prev & next buttons 
